            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0" >Sale No</th>
                             <th class="head0">Sale Date</th>
                                                ...
                                                <td><?php echo $slno++; ?></td> 
                                                 ...
                                                 <td><?php echo $cmn->dateformatindia($row_get['saledate']); ?></td>                                                 <td><?php echo number_format(round($total+$gst),2); ?></td>
                                                  ...
                                                  <td> <a class="btn btn-danger"onClick="show_model('<?php echo $row_get['saleid']; ?>','<?php echo round($total+$gst); ?>','<?php echo $suppartyid; ?>');" style="margin-left:20px;"><strong>Add Payment</strong></a></td>
                                                   ...
                                                   <td>  <?php if($billtype=="withtax"){ ?>&nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-primary btn-sm" href="pdf_sale_chalana5.php?saleid=<?php echo  $row_get['saleid']; ?>" target="_blank" >Challan </a> <?php }?>&nbsp; &nbsp;&nbsp;&nbsp;<?php if($billtype=="withouttax") {?><a class="btn btn-success" href="pdf_sale_details_prnita5.php?saleid=<?php echo  $row_get['saleid']; ?>" target="_blank" > Invoice A5</a>  &nbsp; &nbsp; <a class="btn btn-success" href="pdf_sale_invoice.php?saleid=<?php echo  $row_get['saleid']; ?>" target="_blank" > Invoice A4 </a><?php } ?></td>
