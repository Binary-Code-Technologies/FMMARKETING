...
include("../../adminsession.php");
 ...
 $suppartyid=$cmn->getvalfield($connection,"m_supplier_party","suppartyid","supparty_name='$search_supplier'");
  $cust_type=$cmn->getvalfield($connection,"m_supplier_party","cust_type","suppartyid='$suppartyid'"); 

if($cust_type=="wholeseller")
{
   $rate=$cmn->getvalfield($connection,"m_product","wholeseller_rate","productid='$productid'");
}
