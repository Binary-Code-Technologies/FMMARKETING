...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	global $title1,$title2;
		...
		$this->Cell(15,8,' S.No','1',0,'L',0);                      
		$this->Cell(57,8,'Supplier Name',1,0,'L',0); 
		$this->Cell(40,8,'Mobile No.',1,0,'L',0);
		$this->Cell(70,8,'Address',1,0,'L',0);
		$this->Cell(45,8,'Opening Balnce',1,0,'L',0);
		$this->Cell(50,8,'Opening Balance Date',1,1,'L',0);
		// $this->Cell(35,8,'Bank Address',1,0,'L',0);  
		// $this->Cell(45,8,'Opening Balnce',1,1,'L',0);   
		$this->SetWidths(array(15,57,40,70,45,50,));
...
$pdf->SetTitle($title1);
$title2 = "(Supplier Report Details)";
$pdf->SetTitle($title2);
$pdf->AliasNbPages();
$pdf->AddPage('L','A4');
$slno=1;
$sql_list = mysqli_query($connection,"Select * from  m_supplier_party where type_supparty ='supplier' and suppartyid <> 0 order by suppartyid desc");
				  ...
				  $pdf->Row(array($slno++,$supparty_name,$mobile,$address,number_format($prevbalance,2),$prevbal_date));
										  
			
			 }
		
	      $pdf->Output('Supplier Report','I');				        
 ?>