                    ...
                    <thead>
                        <tr>
                             ...
                             <th width="11%" class="head0">Return Date</th>
                              <th width="11%" class="head0">Return Qty</th>
                              <th width="11%" class="head0">Return Amount</th>
                                ...
                                <?php
									...
									while($row_get = mysqli_fetch_assoc($sql_get))
									{
										...
										$billno = $cmn->getvalfield($connection,"saleentry","billno","saleid='$saleidl'");
											...
											$ret_qty = $cmn->getvalfield($connection,"salereturn","sum(ret_qty)","saleid='$saleidl'");
												$return_amt = $cmn->getvalfield($connection,"salereturn","sum(return_amt)","saleid='$saleidl'");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-plus"></i> Add Return Product</h4>
                    </div>
                     ...
                     <input class="form-control" name="bal_qty" id="bal_qty"  value="" autocomplete="off" autofocus="" type="text" style="color:#00F;"  readonly >                    
                                        ...
                                        <td> 
               <input class="form-control" name="qty" id="mqty"  value="1" autocomplete="off" autofocus="" type="text"  placeholder="Enter Quantity" style="width:60%" onChange="checkqty(this.value);"   >  
              ...
              <input type="button"  style="font-size:16px;" class="btn-sm btn btn-danger" id="minus" value="--" onClick="minusqty();" >                                        
                                      ...
                                      <tr>
                                      <th colspan="2">Return Amount &nbsp;<span style="color:#F00;">*</span></th>
                                    
                                    </tr>
                                    <tr>  
                                      <td colspan="2">                                           
                     <input class="form-control" name="return_amt" id="return_amt"  value="" autocomplete="off" autofocus="" type="text" style="color:#00F;"   >                    
                                     </td>
	...
	function checkqty(qty)
{
		...
		function addlist()
	{
		...
		if(return_amt =='')
		{
			alert('Return Amount cant be blank');	
			return false;
		...
		else
		{
			jQuery.ajax({
			  ...
			  data: 'productid='+productid+'&unitid='+unitid+'&qty='+qty+'&return_amt='+return_amt+'&sale_retdate='+sale_retdate+'&saleid='+saleid,
			  dataType: 'html',
			  success: function(data){				  
			 // alert(data);
				getrecord(saleid);
