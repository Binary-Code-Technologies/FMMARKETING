...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	function Header()
	{
		...
		$this->Cell(35,6,'Product',1,0,'L',0);
		$this->Cell(25,6,'Categary',1,0,'L',0);
		$this->Cell(20,6,'Open. Bal.',1,0,'L',0);
		$this->Cell(20,6,'Purchased',1,0,'L',0);
		$this->Cell(25,6,'Purchase Ret',1,0,'L',0);
		$this->Cell(20,6,'Sold',1,0,'C',0);
		$this->Cell(25,6,'Sale Ret',1,0,'L',0);
		$this->Cell(20,6,'Stock',1,1,'L',0);
    	$this->SetX(5);
		$this->SetWidths(array(10,35,25,20,20,25,20,25,20));
...
$slno=1;									
	...
	$pdf->Row(array($slno++,$row_get['prodname'],$catname,$opening_stock,$pur,$pur_ret,$sold,$saleret,$stock));
