...
$crit=" where loginid='$loginid' and type='$type'";
...
if(isset($_POST['sub']))
{
	...
	$sqlforcheck = "select * from user where password = '$oldpass' and userid ='$loginid'";
	$resforcheck = mysqli_query($connection,$sqlforcheck);
	$cnt_check = mysqli_num_rows($resforcheck);
	if($cnt_check != 0)
	{
		if($newpass == $confirmpass)
		{
			$sql="update user set password = '$newpass' where userid= '$loginid'";
			mysqli_query($connection,$sql);
			$action=2;
			$cmn->InsertLog($connection,$pagename, "Profile Setting", "Change Password", "m_users", "userid", $loginid, "Changed Password");
