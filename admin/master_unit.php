...
{
	$unit_name = test_input($_POST['unit_name']);
	
	$enable="enable";
	
	//check Duplicate
	$check = check_duplicate($connection,$tblname,"unit_name = '$unit_name' && $tblpkey <> $keyvalue");
			...
			if($keyvalue == 0)
		{
			$form_data = array('unit_name'=>$unit_name,'enable'=>$enable,'ipaddress'=>$ipaddress,'createdate'=>$createdate,'createdby'=>$loginid);
		...
		{
			//update
			$form_data = array('unit_name'=>$unit_name,'enable'=>$enable,'ipaddress'=>$ipaddress,'lastupdated'=>$createdate,'createdby'=>$loginid);
              ...
              <?php include("../include/alerts.php"); ?>
                ...
                <div class="widgetcontent  shadowed nopadding">
                    ...
                    <?php echo  $dup;  ?>
                       <div class="lg-12 md-12 sm-12">
                                ...
                                <span class="field"><input type="text" name="unit_name" id="unit_name" class="input-xxlarge" value="<?php echo $unit_name;?>" 
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                               ...
                               <?php
									$slno=1;
									$sql_get = mysqli_query($connection,"select * from m_unit where 1=1 order by unitid desc");
									while($row_get = mysqli_fetch_assoc($sql_get))
									{
									   ?> <tr>
                                                <td><?php echo $slno++; ?></td> 
                                                <td><?php echo $row_get['unit_name']; ?></td> 
                              					<td><a class='icon-edit' title="Edit" href='?unitid=<?php echo  $row_get['unitid'] ; ?>'></a></td>
                                                <td>
