...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	//	$this->Cell(144,0,'',T,0,0,'C');
	   ...
	   $this->SetX(6);
		$this->SetFont('courier','b',9);
	    $this->Cell(12,5,"Contact  :",0,0,'C');
		$this->SetFont('courier','b',9);
	   // $this->Cell(33,5,$mobile,0,0,'C');
		$this->Cell(28,5,$mobile,0,0,'C');
		
		$this->SetFont('courier','b',9);
	    $this->Cell(68,5,"Bill Date :",0,0,'R');
		$this->SetFont('courier','b',9);
	   $this->Cell(25,5,$saledate,0,1,'L');
	   
	   $this->SetX(6);
		$this->SetFont('courier','b',9);
	    $this->Cell(12,5,"Address  :",0,0,'C');
		$this->SetFont('courier','b',9);
	   // $this->Cell(33,5,$mobile,0,0,'C');
		$this->Cell(30,5,$cust_address,0,0,'C');
	...
	// Position at 1.5 cm from bottom
		...
		$this->SetTextColor(0,0,0);
		$this->MultiCell(80,3,$term_cond,0,'L');
...
$pdf->Cell(48,6,'Product Name',1,0,'L',1);
$pdf->Cell(20,6,'UNIT',1,0,'C',1);
$pdf->Cell(10,6,'Qty',1,0,'C',1);
$pdf->Cell(16,6,'Rate',1,0,'R',1);
$pdf->Cell(13,6,'Disc(%)',1,0,'R',1);
$pdf->Cell(28,6,'AMOUNT',1,1,'R',1);
$pdf->SetX(2);
$pdf->SetWidths(array(9,48,20,10,16,13,28));
...
$pdf->Cell(28,6,'AMOUNT',1,1,'R',1);
$pdf->SetX(2);
$pdf->SetWidths(array(9,30,20,10,16,13,18,28));
...
$pdf->SetFont('arial','b',9);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(117,5,'SUBTOTAL :',0,0,'R',0);
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(117,5,'FREIGHT CHARGE(Rs) :',0,0,'R',0);
...
$pdf->SetFont('arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(117,5,'Return Amount(Rs) :',0,0,'R',0);
$pdf->Cell(25,5,number_format($return_amt,2),'0',1,'R',0);
...
$pdf->SetFont('arial','b',9);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(117,5,'NET TOTAL :',0,0,'R',0);
$pdf->Cell(25,5,number_format(round($total-$return_amt),2),'0',1,'R',0);
}
 $pdf->Ln(2);
 $pdf->SetX(5);
