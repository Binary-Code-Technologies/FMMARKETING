...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	function Header()
	{
		global $title1,$title2,$supparty_name,$mobile,$billno,$purchasedate,$gsttinno,$transport_name,$transport_date,$address,$tinno,$company_code,$company_state,$cus_code,$cus_state,$challan_no,$tinno;
		 // courier 25
	   ...
	   $this->Cell(100,3,"Details of Consignee | Shipped To :",1,1,'C');
		...
		$this->Cell(14,6,'UNIT',0,0,'L',1);
		$this->Cell(13,6,'QTY',0,0,'L',1);
		$this->Cell(14,6,'RATE',0,0,'L',1);
		$this->Cell(17,6,'AMOUNT',0,0,'L',1);
		//$this->Cell(10,6,'DISC.',0,0,'L',1);
		$this->Cell(22,6,'CGST',0,0,'L',1);
		$this->Cell(22,6,'SGST',0,0,'L',1);
		$this->Cell(22,6,'IGST',0,0,'L',1);
			...
			while($row_get = mysqli_fetch_assoc($sql_get))
{
	...
	$pdf->Row(array($slno,$catname,$hsn_no,$unit_name,$qty,$rate,$amount,$cgst.' %',number_format($cgstamt,2),$sgst.' %',number_format($sgstamt,2),$igst.' %',number_format($igstamt,2),number_format($amount + $totaltax,2)));
	$tot_qty +=$qty;
	$tot_amt +=$amount;
