...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	function Header()
	{
		global $title1,$title2,$supparty_name,$mobile,$billno,$purchasedate,$gsttinno,$transport_name,$transport_date,$sup_address,$company_code,$company_state,$cus_code,$cus_state,$challan_no,$title3,$title4,$tinno,$address2,$comp_name,$sup_mobile,$tinno;
		 //courier 25
		...
		$this->SetY(8);
		$this->Cell(90);
		$this->Cell(10,0,"TAX PURCHASE INVOICE",0,1,'C');
		$this->Ln(5);
	   ...
	   // $this->Cell(10,0,"Subject to Raipur Jurisdiction",0,1,'C');
		...
		$this->SetX(5);
		$this->SetFont('courier','b',9);
		$this->Cell(29,5,"Supplier Name :",0,0,'L');
		$this->Cell(71,5,$supparty_name,0,0,'L');
		//for Supplier Name
		$this->SetFont('courier','b',9);
		$this->Cell(25,5,"Name",0,0,'L');
		$this->Cell(75,5,":".$comp_name,0,1,'L');
	
	    //for Company Invoice
		$this->SetX(5);
		$this->SetFont('courier','b',9);
		$this->Cell(29,5,"Invoice No",0,0,'L');
		$this->Cell(71,5,":".$billno,0,0,'L');
		//for Supplier GST
		$this->SetFont('courier','b',9);
		$this->Cell(25,5,"Address",0,0,'L');
		$this->Cell(75,5,":".$title3,0,1,'L');
		//for Company Invoice
		$this->SetX(5);
		$this->SetFont('courier','b',9);
		$this->Cell(29,5,"Invoice Date",0,0,'L');
		$this->Cell(71,5,":".$purchasedate,0,0,'L');
		//for Supplier GST
		$this->SetFont('courier','b',9);
		$this->Cell(25,5,"",0,0,'L');
		$this->Cell(75,5,$address2,0,1,'L');
		//for Company Invoice
		//$this->SetX(5);
		//$this->SetFont('courier','b',9);
		...
		$this->SetX(5);
		$this->SetFont('courier','b',9);
		$this->Cell(29,5,"Place of Supply",0,0,'L');
		$this->Cell(71,5,":".$cus_state."(".$cus_code.")",0,0,'L');
		//for Supplier GST
		$this->SetFont('courier','b',9);
		$this->Cell(25,5,"State",0,0,'L');
		$this->Cell(75,5,":"." Chhaattisgarh(22) ",0,1,'L');
		
		$this->SetX(5);
		$this->SetFont('courier','b',9);
		$this->Cell(29,5,"GSTIN",0,0,'L');
		$this->Cell(71,5,":".$tinno,0,0,'L');
		//for Supplier Name
		$this->SetFont('courier','b',9);
		$this->Cell(28,5,"GSTIN",0,0,'L');
		$this->Cell(72,5,$gsttinno,0,1,'L');
