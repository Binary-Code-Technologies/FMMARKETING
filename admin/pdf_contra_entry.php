...
$pdf->SetTitle($title1);
$title2 = "Credit Note Entry Details";
$pdf->SetTitle($title2);
...
$pdf->Cell(100,6,'Bill No',1,0,'L',0);
$pdf->Cell(90,6,'Discount',1,1,'L',0);

$pdf->SetX(5);
$pdf->SetWidths(array(10,100,90));
$pdf->SetFont('Arial','',6);
$slno = 1;
...
$sql_get = mysqli_query($connection,"select * from contra_entry where 1=1 order by contra_id desc");
	...
	$pdf->Row(array($slno++,$billno,$row_get['discount']));
