...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	function Header()
	{
		global $title1,$title2,$supparty_name,$address,$address2,$mobile,$comp_mobile,$billno,$saledate,$gsttinno,$comp_name,$remark;
		 // courier 25
	...
	// Position at 1.5 cm from bottom
		...
		// Page number
		$this->SetX(2);
		//$this->MultiCell(144,5,'|| Developed By Chaaruvi Infotech Raipur, Contact us- +91-9399771312 ||',0,'C');
...
$pdf->Cell(9,6,' Sno','1',0,'L',1);  
$pdf->Cell(68,6,'Item',1,0,'L',1);
$pdf->Cell(15,6,'Qty',1,0,'L',1);
$pdf->Cell(17,6,'Rate',1,0,'L',1);
$pdf->Cell(35,6,'Amount',1,1,'L',1);
...
$pdf->SetFont('Arial','',6);
$slno = 1;
$sql_get = mysqli_query($connection,"Select * from saleentry_detail where saleid='11111'");
...
$mysql_tax=mysqli_query($connection,"select distinct tax_id from saleentry_detail where saleid='11111111' && tax_id !='10'");
