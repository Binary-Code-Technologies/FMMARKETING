        	...
        	<div class="contentinner">
             <?php include("../include/alerts.php"); ?>
                ...
                <div class="widgetcontent  shadowed nopadding">
                    <form class="stdform stdform2" method="get" onSubmit="return checkinputmaster('productid,numofbarchode nu');" action="pdf_print_barcode.php" target="_blank">
                    <?php echo  $dup;  ?>
                       <div class="lg-12 md-12 sm-12">
                        ...
                        <span class="field"> 
                           ...
                           <center> <p class="stdformbutton">
                                ...
                                <a href="generate_barcode_print.php"  name="reset" id="reset" class="btn btn-success">Reset</a>
                           </p> </center>
                        </form>
                    </div>
        </div><!--maincontent-->   
