...
$module = "GST Sale Report";
$submodule = "GST Sale List";
$btn_name = "Search";
$keyvalue =0 ;
$tblname = "";
$crit = " where 1 = 1 ";
        	...
        	<div class="contentinner">
              <?php include("../include/alerts.php"); ?>
                ...
                <!--widgetcontent-->
                      ...
                      <p align="right" style="margin-top:7px; margin-right:10px;"> <a href="pdf_gst_sale_report.php?todate=<?php echo $todate;?>&fromdate=<?php echo $fromdate;?>&suppartyid=<?php echo $suppartyid;?>" class="btn btn-info" target="_blank">
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="11%" class="head0" style="text-align:center;" >CGST Amount</th>
                             <th width="10%" class="head0" >SGST Amount</th>    
                              <th width="11%" class="head0" style="text-align:center;" >IGST Amount</th>   
                              <th width="11%" class="head0" style="text-align:center;" >Total Tax Amt</th>                                
                        </tr>
                    </thead>
                    <tbody id="record">
                           </span>
                                <?php
									...
									$slno=1;
									$billamount=0;
						$sql_get = mysqli_query($connection,"Select * from saleentry $crit order by saledate");
									while($row_get = mysqli_fetch_assoc($sql_get))
									{
											...
											?> <tr>
											<td><?php echo $slno++; ?></td> 
											<td><strong><?php echo $row_get['billno']; ?></strong></td>
											<td><strong><?php echo $cmn->dateformatindia($row_get['saledate']); ?> </strong></td>
						<td><strong><?php echo $cmn->getvalfield($connection,"m_supplier_party","supparty_name","suppartyid='$suppartyid'"); ?></strong></td>
                        					<td style="text-align:right"> <?php echo number_format($billamount,2);   ?> </td>
                                            ...
                                            <td style="text-align:right;"><?php echo number_format($cgst+$sgst+$igst); ?></td>
                        						</tr>
                        <?php
						}
						?>
