             ...
             <div id="new2">
                ...
                <div class="row-fluid">
                	<table class="table table-condensed table-bordered" style="background-color:#FFF">
							  ...
							  <tr>
							     <td>
                                      <select id="suppartyid" name="suppartyid" class="chzn-select" style="background:url(input-text-9.png) no-repeat 4px 4px;" value="<?php echo $search_supplier; ?>">
							    ...
							    <td>                                           
                                            <input type="text" name="saledate" id="billdate" class="form-control text-red" value="<?php echo $cmn->dateformatindia($saledate);?>" data-inputmask="'alias': 'dd-mm-yyyy'" data-mask >                                           	
                                            </td>
                      ...
                      <select  name="billtype"  class="chzn-select" id="billtype"  >
							  ...
							  <tr>
							    <td>                                           
                                  ...
                                  <td> <select  name="saletype" class="chzn-select" id="saletype" >
                                         <option value="" >-Select-</option>
                    ...
                    <div >
                     ...
                     <tr>
                         ...
                         ?>
                           ...
                           <td><input class="form-control input-mini" type="text" name="rate" id="rate" value="" placeholder='rate'></td>
                           <td><input class="form-control input-mini" type="text" name="qty" id="qty" value="" placeholder='qty'></td>
                            <td>
                           <select name="tax_id" id="tax_id">
                           <option value="">--Select--</option>
                           <?php
						   $sqltax = mysqli_query($connection,"select * from m_tax where enable='enable'");
						   while($rowtax = mysqli_fetch_array($sqltax))
						   {
						   ?>
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0" >Invoice(A5)</th>
                            <th class="head0" >Invoice(A4)</th>
									...
									while($row_get = mysqli_fetch_assoc($sql_get))
									{
									   ...
									   ?> <tr>
                                                <td><?php echo $slno++; ?></td> 
                                                 ...
                                                 <td><?php echo $cmn->dateformatindia($row_get['saledate']); ?></td>                                                 <td><?php echo number_format(round($total+$gst+$igst),2); ?></td>
                                                  <td><?php echo $supparty_name; ?></td>
                                                  <td> <a class="btn btn-danger"onClick="show_model('<?php echo $row_get['saleid']; ?>');" style="margin-left:20px;"><strong>Add Payment</strong></a></td>
                                                  
                                                  
                                                    <td>  
												   <?php 
												   if($billtype=="withtax"){ ?>&nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-primary btn-sm" href="pdf_sale_chalana5.php?saleid=<?php echo  $row_get['saleid']; ?>" target="_blank" >Challan </a> <?php }?>&nbsp; 
                                                   </td>
                                                   
                                                   <td>
												   <?php if($billtype=="withouttax") {?>
                                                   <a class="btn btn-success" href="pdf_sale_details_prnita5.php?saleid=<?php echo  $row_get['saleid']; ?>" target="_blank" > Invoice A5</a> <?php } ?>
                                                   </td>
                                                   
                                                   <td>
                                                   <?php if($billtype=="withouttax") {?>
                                                   <a class="btn btn-success" href="pdf_sale_invoice.php?saleid=<?php echo  $row_get['saleid']; ?>" target="_blank" > Invoice A4 </a><?php } ?>
                                                   </td>
                                                  <td>
...
<div class="modal fade" id="myModal" role="dialog" aria-hidden="true" style="display:none;" >
            <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <input type="button"  style="font-size:16px;" class="btn-sm btn btn-danger" id="minus" value="--" onClick="minusqty();" >                     </td>
                   <td>                                           
                         <input class="form-control" name="rate" id="mrate"  value="" autocomplete="off" autofocus="" type="text" onChange="settotal();" >      </td>
                              ...
                              <th width="18%" style="color:#00F;"><strong>Total &nbsp;</strong><span style="color:#F00;">*</span></th>
                               ...
                               <tr>
                                          ...
                                          <td>                                           
                           <select name="tax_id" id="mtax_id" onChange="getgst(this.value);" >
        ...
        <div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade in" id="myModal1">
           ...
           <tr> 
            ...
            <tr>
            <td colspan="2"> <select name="stateid" id="stateid" class="chzn-select">
                            <option value=""> Select</option>
                              <?php     
...
function updaterecord(prodname,productid,unit_name,unitid,rate,qty,tax_id,total,saledetail_id)
{
...
function getproductinfo()
{
	...
	jQuery.ajax({
			  ...
			  success: function(data){				  
				...
				jQuery('#qty').val('1');
				jQuery('#tax_id').val(jsonobj.tax_id);
				jQuery('#rate').focus();
			    //jQuery("#myModal_payment").modal('hide');
				}
