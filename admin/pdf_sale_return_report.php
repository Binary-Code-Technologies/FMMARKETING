...
$pdf->Cell(80,6,'Product Name',1,0,'L',0);
...
$slno=1;
							//	echo "Select * from salereturn $crit group by saleid order by sale_returnid desc";die;
									$sql_get = mysqli_query($connection,"Select * from salereturn $crit group by saleid order by sale_retdate desc");
	...
	$pdf->Row(array($slno++,$billno,$prodname,$cmn->dateformatindia($row_get['sale_retdate'])));
