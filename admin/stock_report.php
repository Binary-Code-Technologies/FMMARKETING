        	...
        	<div class="contentinner">
              <?php include("../include/alerts.php"); ?>
                ...
                <div class="widgetcontent  shadowed nopadding">
                    ...
                    </button> &nbsp; &nbsp; <a href="stock_report.php"  name="reset" id="reset" class="btn btn-success">Reset</a></td>
                ...
                <!--widgetcontent-->
                      ...
                      <p align="right" style="margin-top:7px; margin-right:10px;"> <a href="pdf_stock_report.php?todate=<?php echo $todate;?>" class="btn btn-info" target="_blank">
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <tbody id="record">
								...
								$todate=$cmn->dateformatusa($todate);
									$slno=1;
								//echo "Select * from in_entry $crit order by outentry_id desc";die;
									...
									$catname=$cmn->getvalfield($connection,"m_product_category","catname","pcatid='$pcatid'");									
									 $pur = 0;																
						$sql_p = mysqli_query($connection,"select purchaseid from purchaseentry where purchasedate <= '$todate'");
						...
						$pur += $cmn->getvalfield($connection,"purchasentry_detail","sum(qty)","productid='$productid' and purchaseid='$row_p[purchaseid]'");//purchase
						 ...
						 $sold = 0;																
						$sql_s = mysqli_query($connection,"select saleid from saleentry where saledate <= '$todate'");
						...
						$sold += $cmn->getvalfield($connection,"saleentry_detail","sum(qty)","productid='$productid' and saleid='$row_s[saleid]'");//purchase
							...
							$stock=$opening_stock+$pur - $sold;
									   ?> <tr>
                                                ...
                                                <td><strong><?php echo number_format($row_get['opening_stock'],2); ?> </strong></td>
