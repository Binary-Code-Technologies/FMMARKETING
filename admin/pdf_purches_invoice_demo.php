  ...
  var $aligns;
	...
	function Header()
	{
	   ...
	   $this->Cell(100,3,"Details of Consignee | Shipped To :",1,1,'C');
		...
		$this->Cell(9,6,'Sno','0',0,'L',1);  
		$this->Cell(31,6,'Product Name',0,0,'L',1);
		$this->Cell(16,6,'HSN/SAC',0,0,'L',1);
		$this->Cell(13,6,'UNIT',0,0,'L',1);
		$this->Cell(10,6,'QTY',0,0,'L',1);
		$this->Cell(14,6,'RATE',0,0,'L',1);
		$this->Cell(17,6,'AMOUNT',0,0,'L',1);
		$this->Cell(10,6,'DISC.',0,0,'L',1);
		$this->Cell(20,6,'CGST',0,0,'L',1);
		$this->Cell(20,6,'SGST',0,0,'L',1);
		$this->Cell(20,6,'IGST',0,0,'L',1);
		$this->Cell(20,6,'Total',0,1,'L',1);
		$this->SetX(5);
		
		$this->SetFont('Arial','B',8);
		$this->SetFillColor(170, 170, 170); //gray
		$this->SetTextColor(255,255,255);
		$this->Cell(120,6,'',1,0,'L',1);
		$this->Cell(10,6,'Rate',1,0,'L',1);
		$this->Cell(10,6,'Amt.',1,0,'L',1);
		...
		$this->SetWidths(array(9,31,16,13,10,14,17,10,10,10,10,10,10,10,20));
			...
			while($row_get = mysqli_fetch_assoc($sql_get))
{
	...
	$pdf->Row(array($slno,$prodname,$hsn_no,$unit_name,$qty,$rate,$amount,$disc,$cgst.' %',$cgstamt,$sgst.' %',$sgstamt,$igst.' %',number_format($igstamt,2),number_format($amount + $gstamt)));
	$tot_qty +=$qty;
	$tot_amt +=$amount;
	$total +=$amount+$gstamt;
...
$pdf->Cell(28,5,number_format(round($tot_amt+$taxamt),2),'0',1,'R',0);
