        ...
        <div class="maincontent">
        	<div class="contentinner">
              <?php include("../include/alerts.php"); ?>
            	<!--widgetcontent-->        
                   <p align="right" style="margin-top:7px; margin-right:10px;">  <a href="excel_report_expense.php" class="btn btn-info" >Excel</a><a href="pdf_expense_report.php" class="btn btn-info" target="_blank">
