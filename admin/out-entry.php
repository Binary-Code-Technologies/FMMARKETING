...
if(isset($_POST['submit']))
{
	...
	//check Duplicate
	$check = check_duplicate($connection,$tblname,"shop_name = '$shop_name' && $tblpkey <> $keyvalue");
              ...
              <?php include("../include/alerts.php"); ?>
                ...
                <div class="widgetcontent  shadowed nopadding">
                    ...
                    <div class="lg-12 md-12 sm-12">
                                ...
                                <select name="shop_id" id="shop_id" style="width:80%;"  class="chzn-select" >
                                    ...
                                    <?php
									$sql=mysqli_query($connection,"select * from m_shop order by shop_name");
            	...
            	<!--<table class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                               ...
                               <?php
									/*$slno=1;
									$sql_get = mysqli_query($connection,"select * from m_shop where 1=1 order by inentry_id desc");
