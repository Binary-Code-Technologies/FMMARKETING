...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	function Header()
	{
		...
		$this->Cell(50,6,'Bill No',1,0,'L',0);
		$this->Cell(40,6,'Purchase Date',1,0,'L',0);
		$this->Cell(70,6,'Customer Name',1,0,'L',0);
		$this->Cell(30,6,'Amount',1,1,'R',0);
		$this->SetX(5);
		$this->SetWidths(array(10,50,40,70,30));
...
$sql_get = mysqli_query($connection,"Select * from purchaseentry $crit order by purchaseid desc");
 while($row_get = mysqli_fetch_assoc($sql_get))
  {
		...
		$pdf->Row(array($slno++,$row_get['billno'],$cmn->dateformatindia($row_get['purchasedate']),$supparty_name,number_format(round($total+$gst),2)));
		...
		$pdf->Cell(170,6,'Net Total','1',0,'R',0);  
		$pdf->Cell(30,6,number_format(round($netamount),2),1,1,'R',0);
