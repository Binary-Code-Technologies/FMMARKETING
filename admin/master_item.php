...
if(isset($_POST['submit']))
{
	...
	//check Duplicate
	$check = check_duplicate($connection,$tblname,"item_name = '$item_name'");
              ...
              <?php include("../include/alerts.php"); ?>
                            ...
                            <p>
                             ...
                             <p>
                                ...
                                autofocus/></span>
                                                ...
                                                <?php
												/*$sql = mysqli_query($connection,"select mobile,count_name from master_country order by mobile desc");
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                               ...
                               <?php
									$slno=1;
									$sql_get = mysqli_query($connection,"select * from m_item where 1=1 order by itemid desc");
