...
<script src="../js/input-mask/jquery.inputmask.extensions.js" type="text/javascript"></script>
    ...
    <body>
                ...
                <!-- Main content -->
                            ...
                            <!-- /.box -->
                             <?php $prevbalance = $cmn->getsupplieropeningbalance($connection,$fromdate,$suppartyid); ?>
                                        ...
                                        <tbody>
											...
											?>
                                            	<tr>
                                                    ...
                                                    <td align="right"><i class="fa fa-inr"></i> <?php echo number_format($total_pur,2); ?></td>
