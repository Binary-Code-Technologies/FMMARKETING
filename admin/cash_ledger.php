    ...
    <body>
                ...
                <!-- Main content -->
					...
					<tr>                                        
                                    ...
                                    <td width="17%"><input type="text" name="fromdate" id="fromdate" value="<?php echo $cmn->dateformatindia($fromdate); ?>" placeholder="dd-mm-yyyy" ></td>
                        ...
                        <div style="float:left; width:49%">
                                    ...
                                    <table border="1" width="100%">
                                        ...
                                        <tbody>
                                            <?php
											$netamt=0;
											$sqlgetincome=mysqli_query($connection,"select * from payment where payment_type !='CASH' and pay_mode='received' $cond and paydate between '$fromdate' and '$todate'");
											...
											?>
                                            	<tr>
                                                    <td><?php echo ++$slno; ?></td>
                                                    <td><?php echo $rowgetincome['receiptno']; ?></td>
											...
											?>
                                              ...
                                              <?php
											$totamt=0;
											$sqlgetincome=mysqli_query($connection,"select * from other_income where payment_type !='CASH' $cond  and incom_date between '$fromdate' and '$todate'");
											while($rowgetincome=mysqli_fetch_assoc($sqlgetincome))
											{
												$amount=0;
												$suppartyid=$rowgetincome['suppartyid'];
											...
											?>
                                            	<tr>
                                                    ...
                                                    <td colspan="2" style="text-align:right;">Other Income</td>
                                        ...
                                        <tfoot bgcolor="#CCCCCC">
                                           <tr>
                                                ...
                                                <th  style="text-align:right"><i class="fa fa-inr"></i> <?php echo number_format(round($nettotalincome),2); ?></th>
                        ...
                        <div style="float:right; width:49%">
                                    ...
                                    <table border="1" width="100%">
                                        ...
                                        <tbody>
											...
											$netamt=0;
											$slno=0;
											$sqlgetincome=mysqli_query($connection,"select * from payment where payment_type !='CASH' $cond  and pay_mode='paidtosupp' and paydate between '$fromdate' and '$todate'");
											while($rowgetincome=mysqli_fetch_assoc($sqlgetincome))
											{
												$payamt=0;
												$suppartyid=$rowgetincome['suppartyid'];
											...
											?>
                                              ...
                                              <?php
											$totamt=0;
											$sqlgetincome=mysqli_query($connection,"select * from other_expense where payment_type !='CASH'  $cond  and expen_date between '$fromdate' and '$todate'");
											while($rowgetincome=mysqli_fetch_assoc($sqlgetincome))
											{
												$amount=0;
												$amount=$rowgetincome['amount'];
											...
											?>
                                            	<tr>
                                                    ...
                                                    <td  style="text-align:right;">Other Expense</td>
                                                    <td><?php echo strtoupper($rowgetincome['payto']); ?></td>                
                                                    <td><?php echo $rowgetincome['expen_date'];  ?></td>
                                                    <td align="right"><i class="fa fa-inr"></i> <?php echo number_format($amount,2); ?></td>                                                   
                                                </tr>
