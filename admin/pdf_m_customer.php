...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	global $title1,$title2;
		...
		$this->Cell(20,8,' S.No','1',0,'L',0);                      
		$this->Cell(80,8,'Customer Name',1,0,'L',0);
		// $this->Cell(35,8,'Gender',1,0,'L',0);
		// $this->Cell(30,8,'DOB',1,0,'L',0);
		// $this->Cell(30,8,'Register Date',1,0,'L',0);
		// $this->Cell(30,8,'Disease Type',1,0,'L',0);
		$this->Cell(80,8,'Mobile',1,0,'L',0);  
		$this->Cell(96,8,'Address',1,1,'L',0);   
		$this->SetWidths(array(20,80,80,96));
...
$slno=1;
					 ...
					 $sql_list = mysqli_query($connection,"Select * from m_supplier_party where type_supparty ='party' and suppartyid <> 0 order by suppartyid desc");
									   if($sql_list)
									   {
										   ...
										   {    	
											 ...
											 $dob = $row_list['dob'];
											 $regdate = $row_list['regdate'];
											 $disid = $row_list['disid'];
	...
	$diseasename=$cmn->getvalfield($connection,"m_disease","diseasename","disid = $disid");
				 ...
				 $pdf->SetTextColor(0,0,0);
				  $pdf->Row(array($slno++,$supparty_name,$mobile,$address));
										   }
