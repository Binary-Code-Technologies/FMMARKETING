...
$pdf->Cell(18,6,'RATE',1,0,'C',1);
$pdf->Cell(20,6,'DISC',1,0,'C',1);
$pdf->Cell(20,6,'AMOUNT',1,1,'C',1);

$pdf->SetX(2);
$pdf->SetWidths(array(8,33,15,14,16,18,20,20));
$pdf->SetAligns(array("C","L","C","C","L","R","R","R"));
			...
			while($row_get = mysqli_fetch_assoc($sql_get))
{
	...
	$pdf->Row(array($slno,$prodname,$unit_name,$row_get['qty'],$gst,number_format($rate,2),$disc.'%',number_format($amount,2)));
