...
class PDF_MC_Table extends FPDF
{
  ...
  var $aligns;
	...
	function Header()
	{
		...
		$this->Cell(20,0,"INVOICE No :"." "."123456789765",0,0,'L');
...
$sql_get = mysqli_query($connection,"Select * from saleentry  order by saleid desc");
			...
			//{
				...
				$disc =$row_get['disc'];
			echo $supparty_name = $cmn->getvalfield($connection,"m_supplier_party","supparty_name","suppartyid='$suppartyid'"); 
...
$pdf->SetFont('arial','b',10);
$pdf->SetTextColor(0,0,0);
$pdf->Cell(175,5,'TAX SUMMARY',0,1,'L',0);
$pdf->Ln(5);	
...
$pdf->SetFillColor(170, 170, 170); //gray
$pdf->SetTextColor(255,255,255);
$pdf->Cell(55,6,' RATE','1',0,'C',1);  
$pdf->Cell(90,6,'TAX',1,0,'C',1);
$pdf->Cell(55,6,'NET',1,1,'C',1);

$pdf->SetWidths(array(55,90,55));
$pdf->SetAligns(array("C","L","R"));

    $pdf->SetX(5);	
	$pdf->SetFont('Arial','',8);
	$pdf->SetTextColor(0,0,0);
	$pdf->Row(array("CGST @ 9%","450.00","5,000.00"));
